...
Where theology locates punishment in divine justice and Buddhism in causal mechanism, Western
philosophy secularizes and refines the diagnosis---locating it in the will's own structure.
...
\pagebreak[2]
\input{section-iv/IV_Dostoevsky_content.tex}
\pagebreak[2]
\input{section-iv/IV_Sartre_content.tex}
\pagebreak[2]
\input{section-iv/IV_Beauvoir_content.tex}
\pagebreak[2]
\input{section-iv/IV_Camus_content.tex}
\pagebreak[2]
\input{section-iv/IV_Heidegger_content.tex}
\pagebreak[2]
\input{section-iv/IV_Levinas_content.tex}
\pagebreak[2]
\input{section-iv/IV_Kojeve_content.tex}
\pagebreak[2]
\input{section-iv/IV_Comparative_content.tex}
