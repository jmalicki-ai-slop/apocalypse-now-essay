...
Before tracing the philosophical and theological traditions that diagnosed punitive
fulfillment, we must examine the literary source that gave Coppola his narrative structure.
\textit{Heart of Darkness} \parencite{ConradHOD1990} provides the template for
\textit{Apocalypse Now}: a journey upriver toward a mysterious figure whose attainment reveals
